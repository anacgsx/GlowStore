...
SECRET_KEY = os.environ.get('SECRET_KEY', 'dev-secret-key-glowstore')
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'store.context_processors.favorite_ids',
            ],
        },
    },
]

WSGI_APPLICATION = 'glowstore.wsgi.application'
